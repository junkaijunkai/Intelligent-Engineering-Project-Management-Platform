package com.dahua.pvision.base.security.aspect;
...
import com.dahua.pvision.base.core.enums.BusinessStatus;
import com.dahua.pvision.base.core.enums.HttpMethod;
import com.dahua.pvision.base.core.filter.PropertyPreExcludeFilter;
import com.dahua.pvision.base.core.utils.ServletUtils;
        ...
        if (HttpMethod.PUT.name().equals(requestMethod)
            ...
            operLog.setOperParam(
                    StringUtils.substring(
                            JSON.toJSONString(paramsMap, excludePropertyPreFilter()), 0, 2000));
        }
    }
