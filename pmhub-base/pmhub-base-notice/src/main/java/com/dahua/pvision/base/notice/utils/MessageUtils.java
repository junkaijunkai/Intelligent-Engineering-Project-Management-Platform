...
import com.dahua.pvision.base.notice.domain.entity.WxUpdateMessage;
...
public class MessageUtils {
    ...
    /** 企微消息发送api */
    public static final String WORK_WX_MESSAGE_URL =
            "https://qyapi.weixin.qq.com/cgi-bin/message/send?access_token=%s";

    /** 企微消息更新api */
    public static final String WORK_WX_MESSAGE_UPDATE_URL =
    ...
    public static WxResult sendMessage(WxMessage wxMessage) {
        ...
        JSONObject re =
                JSONUtil.parseObj(
                        HttpRequest.post(url).body(JSONUtil.toJsonStr(wxMessage)).execute().body());
