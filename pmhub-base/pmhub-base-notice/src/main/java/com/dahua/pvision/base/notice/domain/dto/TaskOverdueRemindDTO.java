...
import com.dahua.pvision.base.notice.domain.entity.Message;
import com.dahua.pvision.base.notice.utils.StringCreateUtils;
import lombok.Data;
import lombok.EqualsAndHashCode;

/** 任务逾期提醒 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonSubTypes({@JsonSubTypes.Type(value = TaskOverdueRemindDTO.class, name = "任务逾期提醒")})
@EqualsAndHashCode(callSuper = true)
@Data
public class TaskOverdueRemindDTO extends Message {

    private static final String DESC =
            "<div class='gray'>%s</div> <div class='normal'>您的任务【%s】还有【%s】天到期，请及时处理！</div>";
