...
import com.dahua.pvision.base.notice.domain.dto.MessageDataDTO;
import com.dahua.pvision.base.notice.domain.dto.ProcessWxMessageStateUpdateDTO;
...
public class RocketMqUtils {
    ...
    /** rocketmq 消息Tag */
    public static final String mqTag = "WX_MASSAGE";

    @Resource private RedisService redisService;

    /** 推送到微信topic */
    public static void push2Wx(com.dahua.pvision.base.notice.domain.entity.Message ob) {
        ...
        try {
            ...
            LogFactory.get()
                    .info("Send message successfully, messageId={}", sendReceipt.getMessageId());
