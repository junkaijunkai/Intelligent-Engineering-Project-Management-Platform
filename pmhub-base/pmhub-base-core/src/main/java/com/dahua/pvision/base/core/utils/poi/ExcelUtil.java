package com.dahua.pvision.base.core.utils.poi;

import com.alibaba.excel.EasyExcel;
import com.alibaba.excel.write.builder.ExcelWriterSheetBuilder;
import com.alibaba.excel.write.style.column.LongestMatchColumnWidthStyleStrategy;
import com.dahua.pvision.base.core.annotation.Excel;
import com.dahua.pvision.base.core.annotation.Excels;
import com.dahua.pvision.base.core.config.PmhubConfig;
import com.dahua.pvision.base.core.convert.ExcelBigNumberConvert;
import com.dahua.pvision.base.core.core.domain.AjaxResult;
import com.dahua.pvision.base.core.core.text.Convert;
import com.dahua.pvision.base.core.exception.UtilException;
import com.dahua.pvision.base.core.utils.DateUtils;
import com.dahua.pvision.base.core.utils.StringUtils;
import com.dahua.pvision.base.core.utils.file.FileTypeUtils;
import com.dahua.pvision.base.core.utils.file.ImageUtils;
import com.dahua.pvision.base.core.utils.reflect.ReflectUtils;
import java.io.*;
...
public class ExcelUtil<T> {
    ...
    private Map<String, CellStyle> annotationDataStyles(Workbook wb) {
        ...
        for (Object[] os : fields) {
            ...
            String key =
                    StringUtils.format(
                            "data_{}_{}_{}", excel.align(), excel.color(), excel.backgroundColor());
            ...
            if (!ArrayUtils.contains(this.excludeFields, field.getName())) {
                ...
                if (field.isAnnotationPresent(Excels.class)) {
                    ...
                    for (Excel attr : excels) {
                        if (attr != null
                                && (attr.type() == Excel.Type.ALL || attr.type() == type)) {
                            field.setAccessible(true);
                            fields.add(new Object[] {field, attr});
                        }
                    }
     ...
     * @param response 响应体
     */
    public static <T> void exportExcel2(
