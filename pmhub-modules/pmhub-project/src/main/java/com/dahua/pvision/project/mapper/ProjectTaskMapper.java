...
import com.dahua.pvision.project.domain.vo.project.task.TaskExportVO;
import com.dahua.pvision.project.domain.vo.project.task.TaskNotifyDTO;
import com.dahua.pvision.project.domain.vo.project.task.TaskReqVO;
import com.dahua.pvision.project.domain.vo.project.task.TaskResVO;
...
public interface ProjectTaskMapper extends BaseMapper<ProjectTask> {
    ...
    List<TaskResVO> queryMyCreatedTaskList(
            @Param("projectId") String projectId, @Param("username") String username);

    List<TaskResVO> queryMyExecutedTaskList(
            @Param("projectId") String projectId, @Param("userId") Long userId);

    List<TaskResVO> queryMyPartookTaskList(
            @Param("projectId") String projectId, @Param("userId") Long userId);
