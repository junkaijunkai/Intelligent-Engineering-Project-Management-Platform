package com.dahua.pvision.workflow.job;

import com.dahua.pvision.workflow.domain.vo.TodoNumVO;
import com.dahua.pvision.workflow.service.IListenerService;
...
public class TodoRemindJob {
    ...
    @Autowired IListenerService listenerService;
    ...
    public void sayWord() {
        ...
        for (TodoNumVO todoNumVO : todoNumVOList) {
            ...
            //            String detailUrl =  SsoUrlUtils.ssoCreate(appid,agentid,
            // host+path+ssoPath+ URLEncoder.encode(host+URL));
            ...
            //            todoRemindDTO.setOaContext("您目前还有【" + todoNumVO.getNum() +
            // "】个审批请求未处理，请及时处理");
