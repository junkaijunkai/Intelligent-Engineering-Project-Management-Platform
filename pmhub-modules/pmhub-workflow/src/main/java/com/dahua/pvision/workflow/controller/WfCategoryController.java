...
import com.dahua.pvision.base.core.core.validate.QueryGroup;
...
public class WfCategoryController extends BaseController {
    ...
    @GetMapping("/list")
    public Table2DataInfo<WfCategoryVo> list(
            @Validated(QueryGroup.class) WfCategoryBo bo, PageQuery pageQuery) {
    ...
    public R<Void> add(@Validated(AddGroup.class) @RequestBody WfCategoryBo categoryBo) {
        if (UserConstants.NOT_UNIQUE.equals(
                categoryService.checkCategoryCodeUnique(categoryBo.getCode()))) {
