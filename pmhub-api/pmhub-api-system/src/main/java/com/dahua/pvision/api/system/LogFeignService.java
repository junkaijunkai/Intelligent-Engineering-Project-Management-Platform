...
import com.dahua.pvision.api.system.factory.LogFeignFallbackFactory;
...
/** 日志服务 */
@FeignClient(
        contextId = "logFeignService",
        value = ServiceNameConstants.SYSTEM_SERVICE,
        fallbackFactory = LogFeignFallbackFactory.class)
