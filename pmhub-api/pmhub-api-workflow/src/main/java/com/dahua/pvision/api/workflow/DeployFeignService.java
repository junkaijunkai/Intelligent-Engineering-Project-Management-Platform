package com.dahua.pvision.api.workflow;

import com.dahua.pvision.api.workflow.factory.ProcessFeignFallbackFactory;
...
public interface DeployFeignService {
    ...
    R<?> selectList(
            List<String> taskId, @RequestHeader(SecurityConstants.FROM_SOURCE) String source);
    ...
    R<Boolean> insertOrUpdateApprovalSet(
            ApprovalSetDTO approvalSetDTO,
            @RequestHeader(SecurityConstants.FROM_SOURCE) String source);
